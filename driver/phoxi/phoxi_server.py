...
import sys
sys.path.append("./")
import driver.phoxi.phoxi_pb2 as pxmsg
import driver.phoxi.phoxi_pb2_grpc as pxrpc
...
class PhoxiServer(pxrpc.PhoxiServicer):
    ...
    def saveply(self, request, context):
        ...
        date: 20210726
        """
        self.__pcins.saveply(request.path)
        return pxmsg.Empty()
...
if __name__ == "__main__":
    # serve(serialno = "2020-01-102-LC3", host = "127.0.0.1:18300")
    serve(serialno = "JHE-052", host = "127.0.0.1:18300")
